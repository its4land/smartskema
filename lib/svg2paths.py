...
def svg2paths2(svg_file_location,
    ...
    return_svg_attributes=True by default.  See svg2pathsdom() docstring for more
    info."""
...
def svg2pathss2(svg_string,
               convert_lines_to_paths=True,
               convert_polylines_to_paths=True,
               convert_polygons_to_paths=True,
               return_svg_attributes=True):
    """Convenience function; identical to svg2pathss() except that
    return_svg_attributes=True by default.  See svg2pathsdom() docstring for more
    info."""
