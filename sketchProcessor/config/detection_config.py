...
sketchProcessor = os.path.join(APP_ROOT,"sketchProcessor")
SKETCH_PROCESSOR_PATH = os.path.join(sketchProcessor,"output")
#print(SKETCH_PROCESSOR_PATH)
...
MODEL_PATH = os.path.join(SKETCH_PROCESSOR_PATH,"tiny_sketch3.model")
#MODEL_PATH = "./sketchProcessor/output/tiny_sketch3.model"

# define the path to the dataset mean
DATASET_MEAN_STAMP = os.path.join(SKETCH_PROCESSOR_PATH,"stamp.json")

#DATASET_MEAN_STAMP = "./sketchProcessor/output/stamp.json"
#DATASET_MEAN_HAND_DRAWN = "./sketchProcessor/output/hand_drawn.json"
DATASET_MEAN_HAND_DRAWN = os.path.join(SKETCH_PROCESSOR_PATH,"hand_drawn.json")
#"./sketchProcessor/output/hand_drawn.json"
# define the path to the output directory used for storing plots,
# classification reports, etc.
OUTPUT_PATH = SKETCH_PROCESSOR_PATH #"./sketchProcessor/output"
